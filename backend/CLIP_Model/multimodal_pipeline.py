...
try:
    ...
    from CLIP_Model.clip import CLIPBackend

try:
    from .caption import CaptionBackend
except ImportError:
    from CLIP_Model.caption import CaptionBackend

try:
    from .audio import AudioBackend
except ImportError:
    from CLIP_Model.audio import AudioBackend

try:
    from .text import TextBackend
except ImportError:
    from CLIP_Model.text import TextBackend
